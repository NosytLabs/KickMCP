...
```env
# Your Kick OAuth credentials (like your special ingredients)
...
Kick uses OAuth 2.0 for authentication. Here's how to set it up:
...
1. **Get Your OAuth Credentials**
   ...
   - Fill in the form:
     ...
     - Redirect URI: Where Kick should send users after authentication
   - You'll get two important pieces:
...
4. **Using Your Access Token**
   ...
   ```
   - The token will expire after a certain time
   - Use `refreshAccessToken` to get a new token when needed
...
1. **Authorization Request**
   - User clicks your app's login button
   - They're redirected to Kick's authorization page
   - User approves your app's requested permissions

2. **Token Exchange**
   - Kick redirects back to your app with an authorization code
